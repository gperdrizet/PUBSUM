...
import optimization.device_map.optimize as device_map
...
if __name__ == "__main__":
    ...
    arguments = [
        ['--device_map', 'Run huggingface device map optimization?']
    ...
    # Huggingface device map strategy optimization
    if args.hf_device_map == 'True' or args.run_all == 'True':
        ...
        p = Process(target=device_map.optimize,
            kwargs=dict(
                ...
                resume=args.resume,
                results_dir=f'{conf.OPTIMIZATION_DIR}/device_map',
                replicates=10,
