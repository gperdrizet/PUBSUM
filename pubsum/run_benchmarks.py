    ...
    if args.batched_summarization == 'True' or args.run_all == 'True':
        ...
        p = Process(target=batched_summarization.benchmark,
            kwargs=dict(
                ...
                replicates=3,
                batches=3,
                batch_sizes=[1, 5, 10, 15, 20, 25, 26, 27, 28, 29, 30, 40, 50, 60, 70, 80, 85, 90, 95, 100],
    ...
    if args.parallel_batched_summarization == 'True' or args.run_all == 'True':
        ...
        p = Process(target=parallel_batched.benchmark,
            kwargs=dict(
                ...
                replicates=3,
                batches=3,
                batch_sizes=[1, 2, 4, 8, 16, 18, 20, 22, 24, 26, 28, 30, 32, 64, 128],
                workers_per_gpu=[1, 2, 3, 4, 5, 6, 7, 8],
                gpus=conf.GPUS,
                quantization_strategies=['none', 'four bit nf4'],
                db_name=conf.DB_NAME,
                user=conf.USER,
